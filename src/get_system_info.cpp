...
void writeSystemInfoToFile(const std::wstring& filePath) {
    ...
    switch (siSysInfo.wProcessorArchitecture) {
        case PROCESSOR_ARCHITECTURE_AMD64: out << L"x64 (AMD or Intel)\n"; break;
        case PROCESSOR_ARCHITECTURE_ARM: out << L"ARM\n"; break;
        case PROCESSOR_ARCHITECTURE_IA64: out << L"Intel Itanium-based\n"; break;
        case PROCESSOR_ARCHITECTURE_INTEL: out << L"x86\n"; break;
        default: out << L"Unknown architecture\n"; break;
    }
    ...
    for (wchar_t letter = L'A'; letter <= L'Z'; ++letter) {
        if (drives & (1 << (letter - L'A'))) {
            ...
            out << L"DISK " << root << L" - ";
            switch (type) {
                case DRIVE_FIXED: out << L"HDD"; break;
                case DRIVE_REMOVABLE: out << L"REMOVABLE"; break;
                case DRIVE_CDROM: out << L"CD-ROM"; break;
                case DRIVE_REMOTE: out << L"REMOVE"; break;
                default: out << L"OTHER"; break;
            }
